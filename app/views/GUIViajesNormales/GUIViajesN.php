    ...
    <div class="container">
      <div class="row">
        <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
          ...
          <a href="#about" class="main-button-slider">Conoce más</a>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-5" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
          <img src="<?php echo URLROOT; ?>/public/images/logo.png" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
        </div>
        <div class="col-12  justify-content-center text-white">
          <h2 class="text-center mb-3">Selecciona un viaje</h2>
          <div class="row">
            <?php if (sizeof($data['itinerarios']) === 0) : ?>
            <?php else : ?>
              <?php foreach ($data['itinerarios'] as $itinerario) : ?>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 card">
                  <form class="p-1" method="post" action="<?php echo URLROOT . "/OViajesNormales/GUIReservacionVN" ?>">
                    <p class="text-center text-dark mb-1"><i class="fa fa-bus"></i> Origen: <?php echo $itinerario->origen ?></p>
                    <p class="text-center text-dark mb-1"><i class="fa fa-bus"></i> Destino: <?php echo $itinerario->destino ?></p>
                    <p class="text-center text-dark mb-1"><i class="fa fa-calendar"></i> Fecha: <?php echo $itinerario->fecha ?></p>
                    <p class="text-center text-dark mb-1"><i class="fa fa-clock-o"></i> Hora: <?php echo $itinerario->hora ?></p>
                    <input type="hidden" name="idItinerario" value="<?php echo $itinerario->id ?>">
                    <input class="btn btn-success btn-block" type="submit" value="Seleccionar">
                  </form>
                </div>
              <?php endforeach; ?>
            <?php endif; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
        <img src="<?php echo URLROOT; ?>/public/images/left-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
        ...
        <ul>
          <li>
            <img src="<?php echo URLROOT; ?>/public/images/about-icon-01.png" alt="">
            <div class="text">
          ...
          <li>
            <img src="<?php echo URLROOT; ?>/public/images/about-icon-02.png" alt="">
            <div class="text">
          ...
          <li>
            <img src="<?php echo URLROOT; ?>/public/images/about-icon-03.png" alt="">
            <div class="text">
      ...
      <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
        <img src="<?php echo URLROOT; ?>/public/images/right-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="owl-carousel owl-theme">
        <div class="item service-item">
          <div class="icon">
            <i><img src="<?php echo URLROOT; ?>/public/images/service-icon-01.png" alt=""></i>
          </div>
        ...
        <div class="item service-item">
          <div class="icon">
            <i><img src="<?php echo URLROOT; ?>/public/images/service-icon-02.png" alt=""></i>
          </div>
        ...
        <div class="item service-item">
          <div class="icon">
            <i><img src="<?php echo URLROOT; ?>/public/images/service-icon-03.png" alt=""></i>
          </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div id="map">
          <!-- How to change your own map point
            ...
            -->
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15049.909265244289!2d-99.08422723212712!3d19.434976935953827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1fc0a0dc117bb%3A0xd2fccdce848139a5!2sAeropuerto%20Terminal%201!5e0!3m2!1ses-419!2smx!4v1573693419451!5m2!1ses-419!2smx" width="100%" height="500px" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
        </div>
      </div>
      <!-- ***** Contact Map End ***** -->

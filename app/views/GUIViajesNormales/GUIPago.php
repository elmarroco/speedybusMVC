    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12  justify-content-center text-white">
          <h2 class="text-center mb-3">Completa tu pago</h2>
          <div class="row">
            <p class="text-center">Tu reservación se completó con exito, te enviamos un correo con los detalles. Debes realizar tu pago para garantizarla.</p>
            <a href="<?php echo $data['linkpago'] ?>" class="btn btn-primary btn-block">Pagar</a>
          </div>
        </div>
      </div>
    </div>
